          ...
          [
            _c("div", { staticClass: "p-8" }, [
              _c(
                ...
                {
                  staticClass:
                    "mb-1 text-center text-xl md:text-2xl text-gray-700 font-bold leading-tight tracking-tight"
                },
                [_vm._v("欢迎登录")]
              ),
              _vm._v(" "),
              _c(
                ...
                {
                  staticClass:
                    "mb-6 text-center text-sm text-gray-600 leading-normal"
                },
                [_vm._v("请输入您的邮箱地址和密码")]
              ),
              _vm._v(" "),
              _c("form", { attrs: { action: "#" } }, [
                _c("div", { staticClass: "mb-4 relative" }, [
                  _c("input", {
                    staticClass:
                      "px-2 py-2 h-12 leading-normal block w-full text-gray-800 bg-white rounded-lg text-left appearance-none outline-none pl-12 border-2 focus:border-teal-600 focus:border-teal-600",
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "absolute left-0 top-0 bottom-0 w-10 flex items-center ml-3 text-gray-400"
                    },
                    [
                      _c(
                        "svg",
                        {
                          staticClass: "stroke-current w-7 h-7",
                          attrs: { fill: "none", viewBox: "0 0 24 24" }
                        },
                        [
                          _c("path", {
                ...
                _vm._v(" "),
                _c("div", { staticClass: "mb-2 relative" }, [
                  _c("input", {
                    staticClass:
                      "px-2 py-2 h-12 leading-normal block w-full text-gray-800 bg-white rounded-lg text-left appearance-none outline-none pl-12 border-2 focus:border-teal-600 focus:border-teal-600",
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "flex justify-center" }, [
      _c("a", { staticClass: "mb-6", attrs: { href: "/" } }, [
        _c("span", { staticClass: "text-3xl font-semibold text-teal-600" }, [
          _vm._v("NeedJob")
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "flex justify-end" }, [
      _c(
        ...
        {
          staticClass:
            "border-b-2 mb-4 text-sm inline-flex text-teal-600 border-teal-200 hover:text-teal-700 hover:border-teal-400",
          attrs: { href: "#" }
        },
        [_vm._v("忘记密码？")]
      )
