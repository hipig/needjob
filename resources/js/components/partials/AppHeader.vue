<template>
  <div class="bg-white px-4 relative z-30" :class="{'shadow-sm': currentRouteName !== 'home'}">
    <div class="md:flex items-center justify-between mx-auto max-w-6xl">
      ...
      <div class="hidden md:block">
        ...
        <a href="/auth/register" class="base-button inline-flex items-center justify-center font-medium focus:outline-none rounded-full px-6 py-1 border-2 border-teal-600 bg-teal-600 hover:bg-teal-700 hover:border-teal-700 text-white">注册</a>
      </div>
    </div>
  </div>
</template>
